...
Download the User Script to use in Tampermonkey: [User Script](https://github.com/arthurbolsoni/Purple-adblock/raw/main/platform/tampermonkey/dist/purpleadblocker.user.js).
